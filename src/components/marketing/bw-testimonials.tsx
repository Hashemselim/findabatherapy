      ...
      <div className="mt-12 grid gap-6 lg:grid-cols-3">
        {behaviorWorkTestimonials.map((testimonial, i) => (
          <BwFadeUp key={testimonial.name} delay={i * 0.1}>
            <div className="flex h-full flex-col rounded-2xl border border-amber-200/40 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:shadow-amber-100/50">
              {/* Quote mark */}
              <span className="text-4xl font-serif leading-none text-[#FFDC33]">
                &ldquo;
              </span>
