...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive glossary of ABA therapy terms and definitions. Learn the meaning of BCBA, RBT, DTT, NET, reinforcement, and other Applied Behavior Analysis terminology.",
  openGraph: {
    title: "ABA Therapy Glossary - Terms & Definitions",
    description:
      "Learn ABA therapy terminology including BCBA, RBT, DTT, reinforcement, and other important terms used in Applied Behavior Analysis.",
...
const glossaryTerms = [
  ...
  {
    term: "BCaBA (Board Certified Assistant Behavior Analyst)",
    definition:
  ...
  // D
  {
    term: "DTT (Discrete Trial Training)",
    definition:
  ...
  },
  {
    ...
    category: "Behavior Procedures",
  },
  // F
  {
    term: "FBA (Functional Behavior Assessment)",
    definition:
  ...
  // N
  {
    term: "NET (Natural Environment Training)",
    definition:
  ...
  {
    term: "PRT (Pivotal Response Training)",
    definition:
  ...
  // R
  {
    term: "RBT (Registered Behavior Technician)",
    definition:
  ...
  // V
  {
    term: "VB-MAPP (Verbal Behavior Milestones Assessment and Placement Program)",
    definition:
...
// Generate DefinedTerm schema for each term
function generateDefinedTermSchema() {
  return {
    "@context": "https://schema.org",
    "@type": "DefinedTermSet",
    name: "ABA Therapy Glossary",
    description:
      "Comprehensive glossary of Applied Behavior Analysis (ABA) therapy terms and definitions",
    url: `${BASE_URL}/learn/glossary`,
    hasDefinedTerm: glossaryTerms.map((item) => ({
      "@type": "DefinedTerm",
      name: item.term,
      description: item.definition,
      inDefinedTermSet: `${BASE_URL}/learn/glossary`,
    })),
  };
}
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
                ABA Therapy{" "}
                <span className="text-[#5788FF]">Glossary</span>
              </h1>
              <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
                Learn the terminology used in Applied Behavior Analysis therapy.
                From BCBA credentials to teaching methods, understand the
                language of ABA.
              </p>
            </div>
          </div>
          ...
          <Card className="border-emerald-500/20 bg-emerald-500/[0.03]">
            <CardContent className="flex flex-col items-center gap-4 p-6 text-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Read our comprehensive ABA guides
                </p>
              </div>
