...
const BASE_URL = "https://www.goodaba.com/get-listed";
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-[#1A2744] sm:text-4xl lg:text-5xl">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 text-[#5788FF]">Nothing falls through the cracks.</span>
              ...
              <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-600 sm:text-xl">
                Replace the{" "}
                <span className="relative inline-block">
                  <span className="relative z-10">Google Forms, spreadsheets, and disconnected tools</span>
                  <span className="absolute -bottom-0.5 left-0 right-0 z-0 h-2.5 rounded-full bg-[#FFDC33]/30" />
                </span>{" "}
                your agency runs on today with branded intake forms, client management,
                automated emails, and a job board — all connected.{" "}
                <strong className="font-semibold text-[#1A2744]">Set up in 10 minutes.</strong>
              </p>
            </div>
          </BwFadeUp>
          ...
          <BwFadeUp delay={0.05}>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-slate-500">
              <span className="flex items-center gap-1.5">
                <span className="font-semibold text-[#1A2744]">500+</span> ABA agencies
              </span>
              <span className="hidden h-3 w-px bg-slate-200 sm:block" />
              <span className="flex items-center gap-1.5">
                <span className="font-semibold text-[#1A2744]">HIPAA</span> compliant
              </span>
              <span className="hidden h-3 w-px bg-slate-200 sm:block" />
              <span className="flex items-center gap-1.5">
                <span className="font-semibold text-[#1A2744]">10 min</span> average setup
              </span>
            </div>
          </BwFadeUp>
