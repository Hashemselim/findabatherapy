...
export const metadata: Metadata = {
  title: "Pricing | GoodABA - Plans for ABA Agencies",
  description:
  ...
  openGraph: {
    title: "GoodABA Pricing | Plans for ABA Agencies",
    description:
    ...
    <div className="min-h-screen bg-[#FFFBF0] text-slate-900">
      ...
      <main>
        ...
        <BwDarkCta
          ...
          accentWord="?"
          subheadline="Set up your agency on GoodABA in minutes. No credit card required to start."
