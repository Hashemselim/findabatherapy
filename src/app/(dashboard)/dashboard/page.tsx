...
import { DashboardCallout, DashboardCard, DashboardEmptyState } from "@/components/dashboard/ui";
    ...
    <div className="space-y-3">
      ...
      {showWelcome && (
        <DashboardCallout
          ...
          icon={CheckCircle2}
          title="You're in."
          description="Your onboarding is complete. Your FindABATherapy presence is live, and the rest of your BehaviorWork dashboard is ready to use or preview based on your plan."
        />
      )}
      <DashboardPageHeader
        title="Overview"
