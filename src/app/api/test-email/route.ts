...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const validTypes = ["inquiry", "payment_failure", "subscription", "feedback", "admin_signup", "admin_first_payment"];
    ...
    const result = await sendTestEmail(to, type as "inquiry" | "payment_failure" | "subscription" | "feedback" | "admin_signup" | "admin_first_payment");
